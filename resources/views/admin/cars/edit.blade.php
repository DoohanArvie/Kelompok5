                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('admin.cars.update', $car) }}"
                                ...
                                <div class="form-group row border-bottom pb-4">
                                    <label for="type_iid" class="col-form-label">Tipe Mobil</label>
                                    <div class="col-sm-12">
                                        <select class="form-control" name="type_id" id="type_id">
                                            @foreach ($types as $type)
                                                <option {{ old('type', $car->type->id) == $type->id ? 'selected' : null }}
                                ...
                                <div class="form-group row border-bottom pb-4">
                                    <label for="pintu" class="col-form-label">Jumlah Pintu</label>
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group row border-bottom pb-4">
                                    <label for="penumpang" class="col-form-label">Jumlah Penumpang</label>
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group row border-bottom pb-4">
                                    <label for="image" class="col-form-label">Gambar Mobil</label>
                                    <div class="col-sm-12">
