...
<div class="container-fluid py-4">
            ...
            <div class="card">
                <div class="card-header p-3 pt-2">
                    ...
                    <div class="text-end pt-1">
                        <p class="text-sm mb-0 text-capitalize">Menunggu Pembayaran</p>
            ...
            <div class="card">
                <div class="card-header p-3 pt-2">
                    <div class="icon icon-lg icon-shape bg-gradient-success shadow-success text-center border-radius-xl mt-n4 position-absolute">
                        <i class="material-icons opacity-10">keyboard_return</i>
                    </div>
                    <div class="text-end pt-1">
                        <p class="text-sm mb-0 text-capitalize">Belum dikembalikan</p>
                        <h4 class="mb-0">35</h4>
                    </div>
                </div>
                <hr class="dark horizontal my-0">
        ...
        <div class="col-xl-3 col-sm-6 mb-4">
            <div class="card">
                <div class="card-header p-3 pt-2">
                    ...
                    <div class="text-end pt-1">
                        <p class="text-sm mb-0 text-capitalize">Jenis Kendaraan</p>
                        <h4 class="mb-0">60</h4>
                    </div>
                </div>
                <hr class="dark horizontal my-0">
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-sm-6 mb-4">
            <div class="card">
                <div class="card-header p-3 pt-2">
                    ...
                    <div class="text-end pt-1">
                        <p class="text-sm mb-0 text-capitalize">Total Sewa</p>
        ...
        <div class="col-xl-3 col-sm-6 mb-4">
            <div class="card">
                <div class="card-header p-3 pt-2">
                    <div class="icon icon-lg icon-shape bg-gradient-light shadow-info text-center border-radius-xl mt-n4 position-absolute">
                        <i class="material-icons opacity-10">call</i>
                    </div>
                    <div class="text-end pt-1">
                        <p class="text-sm mb-0 text-capitalize">Hubungi Kami</p>
