...
@section('content')
    ...
    <div class="container-fluid px-5">
        ...
        <div class="row g-4" id="bike-list">
            <div class="col-lg-10">
                <div class="row">
                    @foreach ($bikes as $bike)
                        <div class="col-lg-3 col-md-6 bike-item" data-category="{{ $bike->type->nama }}" data-passenger="{{ $bike->penumpang }}">
                            <div class="property-item rounded overflow-hidden">
                                <div class="position-relative overflow-hidden">
                                    <a href=""><img class="img-fluid" src="{{ Storage::url($bike->image) }}" alt=""></a>
                                    <div class="bg-white rounded-top text-primary position-absolute start-0 bottom-0 mx-4 pt-1 px-3">
                                        {{ $bike->type->nama }}
                                    </div>
                                </div>
                                <div class="p-4 property-content">
                                    <h5 class="text-primary mb-3">Rp. {{ number_format($bike->price) }} / hari</h5>
                                    <a class="d-block h5 mb-2" href="">{{ $bike->nama_motor }}</a>
                                    <p><i class="text-primary me-2"></i>{{ $bike->description }}</p>
                                </div>
                                <div class="property-footer p-4 pb-0">
                                    ...
                                    <div class="d-flex border-top mt-3">
                                        <div class="flex-fill text-center border-end py-3">
                                            <i class="fa-solid fa-person text-primary me-2"></i>{{ $bike->penumpang }} Penumpang
                                        </div>
                                        <div class="flex-fill text-center border-end py-3">
                                            <i class="fa-solid fa-door-closed text-primary me-2"></i>{{ $bike->pintu }} Pintu
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="collapseType" class="accordion-collapse collapse show" aria-labelledby="headingType" data-bs-parent="#accordionFilters">
                            <div class="accordion-body">
                                <ul class="nav nav-pills flex-column mb-5">
                                    ...
                                    <li class="nav-item mb-2">
                                        <button class="btn btn-outline-primary w-100" data-bs-toggle="pill" data-filter="Manual">Manual</button>
                                    </li>
                                    <li class="nav-item mb-2">
                                        <button class="btn btn-outline-primary w-100" data-bs-toggle="pill" data-filter="Matic">Matic</button>
                                    </li>
                                    <li class="nav-item mb-2">
                                        <button class="btn btn-outline-primary w-100" data-bs-toggle="pill" data-filter="Elektrik">Elektrik</button>
                                    </li>
                                    <li class="nav-item mb-2">
                                        <button class="btn btn-outline-primary w-100" data-bs-toggle="pill" data-filter="Sport">Sport</button>
                                    </li>
                                </ul>
                            </div>
                        </div>
