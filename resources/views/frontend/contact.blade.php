...
@section('content')
    ...
    <div class="site-section container-fluid" id="contact-section">
        <div class="container">
                            ...
                            <div class="col-lg-3 col-md-6 col-12 d-flex" data-aos="fade-down" data-aos-duration="1200"
                                ...
                                <div class="card flex-fill text-center border hover-bg-enlarge">
                                    <div class="card-body">
                                        ...
                                        <a href="mailto:johnsmith@example.com"
                                            class="text-decoration-none text-primary">{{ $setting->email ?? '-' }}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-12 d-flex" data-aos="fade-down" data-aos-duration="1200"
                                ...
                                <div class="card flex-fill text-center border hover-bg-enlarge">
                                    <div class="card-body">
                                        ...
                                        <a href="javascript:void(0);"
                                            class="text-decoration-none text-primary">{{ $setting->alamat ?? '-' }}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-12 d-flex" data-aos="fade-down" data-aos-duration="1200"
                                ...
                                <div class="card flex-fill text-center border hover-bg-enlarge">
                                    <div class="card-body">
                                        ...
                                        <a href="javascript:void(0);" class="text-decoration-none text-primary">Setiap Hari
                                            Jam 09:00 - 17:00 WIB</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="container-fluid col-lg-8 mb-5" data-aos="fade-down" data-aos-duration="1200"
                    data-aos-delay="100">
                    <div class="card card-contact px-4">
                        <div class="text-center btn bg-primary mx-6 shadow-lg text-white" data-aos="slide-right"
                            data-aos-duration="1400" data-aos-delay="120">
                            ...
                            <div class="card-content">
                                <form action="{{ route('contact.store') }}" method="post">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <textarea name="pesan" id="pesan" class="form-control" placeholder="Pesan yang membangun."
                ...
                <div class="container-fluid col-lg-4" data-aos="slide-left" data-aos-duration="1400"
                    data-aos-delay="120">
                    <iframe
