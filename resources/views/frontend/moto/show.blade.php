            ...
            <div class="col-lg-7">
                <div id="carouselExample" class="carousel slide carousel-fade wow fadeInUp" data-wow-delay="0.1s">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{ asset('storage/' . $motos->image1) }}" class="d-block img-fluid w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('storage/' . $motos->image2) }}" class="d-block img-fluid w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('storage/' . $motos->image3) }}" class="d-block img-fluid w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('storage/' . $motos->image4) }}" class="d-block img-fluid w-100" alt="...">
                        </div>
                    </div>
                ...
                <div class="row mt-2 wow slideInLeft" data-wow-delay="0.1s">
                    <div class="col-3 thumbnail">
                        <img src="{{ asset('storage/' . $motos->image1) }}" class="img-fluid" data-bs-target="#carouselExample"
                            data-bs-slide-to="0" alt="...">
                    </div>
                    <div class="col-3 thumbnail">
                        <img src="{{ asset('storage/' . $motos->image2) }}" class="img-fluid" data-bs-target="#carouselExample"
                            data-bs-slide-to="1" alt="...">
                    </div>
                    <div class="col-3 thumbnail">
                        <img src="{{ asset('storage/' . $motos->image3) }}" class="img-fluid" data-bs-target="#carouselExample"
                            data-bs-slide-to="2" alt="...">
                    </div>
                    <div class="col-3 thumbnail">
                        <img src="{{ asset('storage/' . $motos->image4) }}" class="img-fluid" data-bs-target="#carouselExample"
            ...
            <div class="col-lg-5 mt-3">
                <div class="card p-4 wow slideInRight" data-wow-delay="0.1s">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="d-flex align-items-center">
                                    <i class="fa-solid fa-motorcycle text-primary custom-icon me-2"></i>
                    ...
                    <div class="description">
                        ...
                        <p class="text-muted" style="text-align: justify">{{ $motos->description }}</p>
                    </div>
                    <hr>
                    @auth
