                    ...
                    <div class="carousel-inner">
                        @for ($i = 1; $i <= 4; $i++)
                            <div class="carousel-item image-container {{ $i == 1 ? 'active' : '' }}">
                                <img src="{{ asset('storage/' . $motos->{"image$i"}) }}" class="d-block img-fluid"
                                    alt="...">
                            </div>
                        @endfor
                    </div>
                    ...
                    @for ($i = 1; $i <= 4; $i++)
                        <div class="col-3 thumbnail">
                            <div class="image-container">
                                <img src="{{ asset('storage/' . $motos->{"image$i"}) }}" class="img-fluid"
                ...
                <div class="card p-4 wow slideInRight" data-wow-delay="0.1s">
                    ...
                    @auth
                        <div class="d-flex justify-content-between align-items-center mt-3">
                            <a href="{{ route('check_availability', ['vehicle_type' => 'motorcycle', 'vehicle_id' => $motos->id]) }}"
                                class="btn btn-primary">Cek Ketersediaan Motor</a>
                        </div>
                    @else
                        <div class="d-flex justify-content-between align-items-center mt-3">
