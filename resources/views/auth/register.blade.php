                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-7 d-flex align-items-center justify-content-center">
                        <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                            ...
                            <p class="text-white position-relative">Pengalaman Berkendara Tak Terlupakan dengan Layanan Terbaik</p>
                        </div>
                    </div>
                                ...
                                <form role="form" class="text-start" action="{{ route('register') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-text">
                                                <i class="fa-solid fa-eye-slash text-primary text-lg" id="togglePasswordConfirmation" style="cursor: pointer;"></i>
                                            </span>
