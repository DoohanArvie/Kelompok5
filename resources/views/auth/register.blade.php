                    ...
                    <div class="row">
                        <div class="col-xl-5 col-lg-6 col-md-7 d-flex align-items-center justify-content-center">
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                ...
                                <h4 class="mt-2 text-white font-weight-bolder position-relative">"OtoRent | Sewa Rental Mobil Motor"</h4>
                                <p class="text-white position-relative">Tempat sewa motor dan mobil mudah, aman, dan nyaman</p>
                            </div>
                        </div>
